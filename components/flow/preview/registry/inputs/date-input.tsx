...
export function DateInputChat({ block, variables, onAnswer }: ChatBlockProps) {
  ...
  return (
    <form onSubmit={handleSubmit} className="flex gap-2">
      <input type="date" value={value} onChange={(e) => setValue(e.target.value)} className={inputClass} />
